...
//Transaksi
Route::get('transaksi', 'Api\TransaksiController@index'); //show
...
Route::delete('transaksi/{cari}', 'Api\TransaksiController@destroy'); //delete    

//Detail
Route::get('detailtransaksi', 'Api\DetailTransaksiController@index'); //show
Route::post('detailtransaksi', 'Api\DetailTransaksiController@store'); // insert
Route::put('detailtransaksi/{id}', 'Api\DetailTransaksiController@update'); //update
